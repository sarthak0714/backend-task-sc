...
func NewSQLiteRepository(dbPath string) (ports.TradeRepository, ports.PortfolioRepository, error) {
...
func (r *sqliteRepository) AddTrade(ctx context.Context, trade *domain.Trade) error {
...
func (r *sqliteRepository) UpdateTrade(ctx context.Context, id int64, updatedTrade *domain.Trade) error {
	return r.db.Transaction(func(tx *gorm.DB) error {
...
func (r *sqliteRepository) RemoveTrade(ctx context.Context, id int64) error {
	return r.db.Transaction(func(tx *gorm.DB) error {
...
func (r *sqliteRepository) FetchTrades(ctx context.Context, userID string) ([]*domain.Trade, error) {
	var trades []*domain.Trade
	err := r.db.Where("user_id = ?", userID).Find(&trades).Error
	return trades, err
}

func (r *sqliteRepository) UpsertPortfolio(ctx context.Context, portfolio *domain.Portfolio) error {
	return r.db.Save(portfolio).Error
}

func (r *sqliteRepository) FetchPortfolio(ctx context.Context, userID string) ([]*domain.Portfolio, error) {
	var portfolio []*domain.Portfolio
